    ...
    public partial class Form2 : Form
    {
        ...
        private void Form2_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                // Veri tabanından verileri çekmek için SQL sorgusu
                ...
                komut.Parameters.AddWithValue("@id", 1); // Verileri hangi ID'ye sahip kayıttan çekecekseniz ona göre ayarlarız.
                ...
                if (reader.Read())
                {
                    ...
                    // Veri tabanından gelen verileri etiketlere atamak için
